...
<script>
    ...
    export default {
        ...
        created() {
          //  console.log(secret.getAES(this.msg));
            this.userInfo = secret.getAES('333');
          //  console.log(secret.getDAes(this.userInfo));

        },
        methods: {
            encrypt() {
                this.encryptMsg = '密文：' + secret.getAES(this.msg);
                // this.userInfo = secret.encrypt('333')
            },
            decrypt() {

                this.decryptMsg = '明文：' + secret.getDAes(this.userInfo);
            }
        }
    }
</script>
